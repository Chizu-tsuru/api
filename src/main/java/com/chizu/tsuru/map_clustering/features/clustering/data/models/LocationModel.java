...
import com.chizu.tsuru.map_clustering.features.clustering.domain.entities.Location;
...
public class LocationModel {
    ...
    public static LocationModel fromLocation(Location location, ClusterModel clusterModel) {
        var locationModel = new LocationModel(location.getLocationId(), location.getLatitude(), location.getLongitude(), clusterModel);
        var tags = location.getTags().stream().map(tag -> TagModel.fromTag(tag, locationModel)).collect(Collectors.toList());
